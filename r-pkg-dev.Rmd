...
*  Most of this is copied/adapted from a presentation by Markus Gesmann (https://mages.github.io/R_package_development/#1)
...
This creates a template README.Rmd file in the root directory of your package.
Add important information to your README (i.e. How can someone install the package?, What is the purpose of it?, How can someone access the required information?)
